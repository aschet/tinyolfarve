...
{
    tinyolfarve::rgb8 pixel = tinyolfarve::srm_to_srgb(10.0F).to_rgb8();
...
{
    tinyolfarve::rgb8 pixel = tinyolfarve::ebc_to_srgb(20.0F).to_rgb8();
...
void test_srm_and_absorption_agree()
{
    ...
    tinyolfarve::rgb8 via_srm = tinyolfarve::srm_to_srgb(10.0F).to_rgb8();
    tinyolfarve::rgb8 via_absorption =
